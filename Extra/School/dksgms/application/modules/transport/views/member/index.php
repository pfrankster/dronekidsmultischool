                                    ...
                                    <?php $count = 1; if(isset($non_members) && !empty($non_members)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12"> 
                                                    <select  class="form-control col-md-12 col-xs-12" name="route_id" id="route_id_<?php echo $obj->user_id; ?>" required="required">
      ...
      $(document).ready(function(){
        ...
        $('.fn_add_to_transport').click(function(){
          ...
          $.ajax({       
            ...
            data   : {school_id:school_id, user_id : user_id, route_id : route_id},               
            async  : false,
            success: function(response){ 
                if(response){
