...
class Schedule_Model extends MY_Model {
    ...
    function __construct() {
     ...
     public function get_schedule_list($class_id = null, $school_id = null){
     ...
     function duplicate_check($school_id, $exam_id, $class_id, $subject_id, $id = null ){           
     ...
     function duplicate_room_check($school_id, $room_no, $exam_date, $start_time, $id = null ){           
