...
class Suggestion extends MY_Controller {
    ...
    * ********************************************************** */
    public function index($class_id = null, $school_id = null) {
        ...
        $this->data['suggestions'] = $this->suggestion->get_suggestion_list($class_id, $school_id);
    ...
    * ********************************************************** */
    public function subject_id() {
        ...
        if ($this->input->post('id') == '') {
            $suggestion = $this->suggestion->duplicate_check($school_id, $exam_id, $class_id, $subject_id);
            if ($suggestion) {
            ...
            $suggestion = $this->suggestion->duplicate_check($school_id, $exam_id, $class_id, $subject_id, $this->input->post('id'));
            if ($suggestion) {
                $this->form_validation->set_message('subject_id', $this->lang->line('already_exist'));
                return FALSE;
            } else {
