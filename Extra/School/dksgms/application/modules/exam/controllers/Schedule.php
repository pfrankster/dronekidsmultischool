...
class Schedule extends MY_Controller {
    ...
    * ********************************************************** */
    public function index($class_id = null, $school_id = null) {
        ...
        $this->data['schedules'] = $this->schedule->get_schedule_list($class_id, $school_id);
    ...
    * ********************************************************** */ 
    public function subject_id() {
        ...
        if ($this->input->post('id') == '') {
            $schedule = $this->schedule->duplicate_check($school_id, $exam_id, $class_id, $subject_id);
            if ($schedule) {
            ...
            $schedule = $this->schedule->duplicate_check($school_id, $exam_id, $class_id, $subject_id, $this->input->post('id'));
            if ($schedule) {
                $this->form_validation->set_message('subject_id', $this->lang->line('already_exist'));
                return FALSE;
            } else {
    ...
    * ********************************************************** */ 
    public function room_no() {
        ...
        if ($this->input->post('id') == '') {
            $schedule = $this->schedule->duplicate_room_check($school_id, $room_no, $exam_date, $start_time);
            if ($schedule) {
            ...
            $schedule = $this->schedule->duplicate_room_check($school_id, $room_no, $exam_date, $start_time, $this->input->post('id'));
            if ($schedule) {
