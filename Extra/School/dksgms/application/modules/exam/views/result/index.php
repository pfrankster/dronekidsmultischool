                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $result = get_exam_result($obj->id, $this->academic_year_id, $exam_id, $class_id, $section_id ); ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number"  readonly="readonly" value="<?php if(isset($mark) && $mark->obtain_mark > 0 ){ echo $mark->obtain_mark; }else{ echo ''; } ?>"  name="obtain_total_mark[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12 small-field" required="required" size="4" />
                                    </td>
                                    <td>
                                        <input type="number" readonly="readonly" value="<?php if(isset($result) && $result->avg_grade_point > 0 ){ echo $result->avg_grade_point; }else{ echo @round($mark->total_point/$mark->total_subject,2); } ?>"  name="avg_grade_point[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12 small-field" required="required" size="4" />
                                    </td>
