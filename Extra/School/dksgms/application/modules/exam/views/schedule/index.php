                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php } ?>  
                            ...
                            <?php if($this->session->userdata('role_id') != SUPER_ADMIN){  ?>
                                    ...
                                    <?php }else{ ?> 
                                    <select  class="form-control col-md-7 col-xs-12" onchange="get_schedule_list_by_class(this.value);">
                                            <option value="<?php echo site_url('exam/schedule/index/'); ?>">--<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('school'); ?>--</option> 
                                        <?php foreach($schools as $obj ){ ?>
                                            <option value="<?php echo site_url('exam/schedule/index/0/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?></option>
                                        <?php } ?>   
                                    </select>
                                <?php } ?>
                            </li> 
