                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_mark">   
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $mark = get_exam_mark($obj->student_id, $this->academic_year_id, $school_id, $exam_id, $class_id, $section_id, $subject_id); ?>
                            <?php  $attendance = get_exam_attendance($obj->student_id, $this->academic_year_id, $school_id, $exam_id, $class_id, $section_id, $subject_id); ?>
                                <tr>
...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">     
    ...
    function get_section_subject_by_class(class_id, section_id, subject_id){       
        ...
        if(!school_id){
           alert('<?php echo $this->lang->line('select'); ?>');
           return false;
        } 
