                                    ...
                                    <?php $count = 1; if(isset($years) && !empty($years)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } ?>
                                                <a href="<?php echo site_url('administrator/year/activate/'.$obj->id); ?>"><button class="btn btn-success  btn-xs">  <?php echo ($obj->is_running) ? '<i class="fa fa-check"></i> '. $this->lang->line('active') : $this->lang->line('activate'); ?></button></a>     
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    <?php } ?>
