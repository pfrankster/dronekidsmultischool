...
class Classes extends MY_Controller {
    ...
    private function _prepare_class_validation() {
        ...
        $this->form_validation->set_rules('course_price', $this->lang->line('course_price'), 'trim|required');     
        $this->form_validation->set_rules('cash_discount', $this->lang->line('cash_discount'), 'trim|required');     
        $this->form_validation->set_rules('installment', $this->lang->line('installment'), 'trim|required');      
