...
<div class="row tile_count">
    ...
    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner">
            <span class="count_top"><i class="fa fa-paw"></i> <?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('preenroll'); ?></span>
            <div class="count"><?php echo $total_preenroll ? $total_preenroll : 0; ?></div>
            <span class="count_bottom"><?php echo isset($year_session->session_year) ? $year_session->session_year : '' ; ?></span>
        </div>
    </div>
     <?php } ?>
